...
final List<Building> buildingList = [
  ...
  Building(name: "평생교육원", location: LatLng(0.0, 0.0)), // N5
  Building(name: "고시원", location: LatLng(0.0, 0.0)), // N6
  Building(name: "형설관", location: LatLng(0.0, 0.0)), // N7
  Building(name: "보육교사교육원", location: LatLng(0.0, 0.0)), // N8
  Building(name: "언어교육관,보육교사교육원", location: LatLng(0.0, 0.0)), // N9
  Building(name: "대학 본부,국제교류원", location: LatLng(0.0, 0.0)), // N10
  Building(name: "공동실험실습관", location: LatLng(0.0, 0.0)), // N11
  Building(name: "중앙도서관", location: LatLng(0.0, 0.0)), // N12
  Building(name: "경영학관", location: LatLng(0.0, 0.0)), // N13
  Building(name: "인문사회관(강의동)", location: LatLng(0.0, 0.0)), // N14
  Building(name: "사회과학대학본관", location: LatLng(0.0, 0.0)), // N15
  Building(name: "인문대학본관", location: LatLng(0.0, 0.0)), // N16-1
  Building(name: "미술관", location: LatLng(0.0, 0.0)), // N16-2
  Building(name: "미술과", location: LatLng(0.0, 0.0)), // N16-3
  Building(name: "개성재(수위실)", location: LatLng(0.0, 0.0)), // N17-1
  Building(name: "개성재 관리동", location: LatLng(0.0, 0.0)), // N17-2
  Building(name: "개성재(진리관)", location: LatLng(0.0, 0.0)), // N17-3
  Building(name: "개성재(정의관)", location: LatLng(0.0, 0.0)), // N17-4
  Building(name: "개성재(개척관)", location: LatLng(0.0, 0.0)), // N17-5
  Building(name: "계영원", location: LatLng(0.0, 0.0)), // N17-6
  Building(name: "법학관", location: LatLng(0.0, 0.0)), // N18
  Building(name: "제2본관", location: LatLng(0.0, 0.0)), // N19
  ...
  Building(name: "본부관리동", location: LatLng(36.626473, 127.454495)), // S3
  Building(name: "약학대학본관", location: LatLng(36.625625, 127.454415)), // S4-1
  Building(name: "약학연구동", location: LatLng(36.625254, 127.454823)), // S4-2
  Building(name: "농장관리실", location: LatLng(36.625095, 127.453777)), // S5-1
